package cn.org.upthink.persistence.mybatis.dto;

import cn.org.upthink.persistence.mybatis.util.CookieUtils;
...
public class Page<T> implements java.io.Serializable{
	...
	public Page(HttpServletRequest request, HttpServletResponse response){
		this(request, response, -2, false);
	}

	public Page(HttpServletRequest request, HttpServletResponse response, boolean showPage){
		this(request, response, -2, showPage);
	}
	 ...
	 */
	public Page(HttpServletRequest request, HttpServletResponse response, int defaultPageSize, boolean showPage){
...
//	}
	...
	public void setPageSize(int pageSize) {
        ...
        //20180607
        if(this.pageSize>100 && !isAllRecord()){
            this.pageSize = 100;
        }
	}
	...
	public void setIsAllRecord(boolean allRecord) {
		isAllRecord = allRecord;
	}
